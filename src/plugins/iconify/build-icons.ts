...
const sources: BundleScriptConfig = {
  ...
  json: [
    ...
    join(__dirname, '../../../node_modules/@iconify-json/tabler/icons.json'),
    {
      filename: join(__dirname, '../../../node_modules/@iconify-json/mdi/icons.json'),
      icons: [
        'close-circle',
        'language-javascript',
        'language-typescript',
    ...
    {
      filename: join(__dirname, '../../../node_modules/@iconify-json/fa/icons.json'),
      icons: [
        'circle',
      ],
    },
