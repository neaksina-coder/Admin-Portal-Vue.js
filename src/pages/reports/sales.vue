...
const requestUrl = createUrl('/reports/sales/summary', {
  query: {
...
<template>
  <section>
    <VCard class="mb-6">
      <VCardItem>
        <VCardTitle>Sales Report</VCardTitle>
      </VCardItem>
      <VCardText>
        <VRow>
          <VCol cols="12" sm="6">
      ...
      <VCardText>
        <VRow>
          <VCol cols="12" sm="6">
            <VCard variant="tonal">
              <VCardText>
                <div class="text-body-1 text-high-emphasis">Total Revenue</div>
                <h4 class="text-h4">{{ summary.totalRevenue ?? 0 }}</h4>
              </VCardText>
            </VCard>
          </VCol>
          <VCol cols="12" sm="6">
            <VCard variant="tonal">
              <VCardText>
                <div class="text-body-1 text-high-emphasis">Total Sales</div>
                <h4 class="text-h4">{{ summary.totalSales ?? 0 }}</h4>
              </VCardText>
            </VCard>
          </VCol>
        </VRow>
